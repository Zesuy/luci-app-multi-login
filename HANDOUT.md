...
6. For a fresh session, use the retained r19 artifact/checksum and repeat only the explicitly authorized Phase 9 device cells. The disposable QEMU smoke and earlier behavior evidence remain valid; keep real-device and Portal actions separately authorized.
